...
namespace Drupal\dcloud_usage\EventSubscriber;
...
class ApiRequestSubscriber implements EventSubscriberInterface {
  ...
  public function onKernelResponse(ResponseEvent $event) {
    ...
    try {
      ...
      $this->database->insert('dcloud_usage_api_requests')
        ->fields([
      ...
      \Drupal::logger('dcloud_usage')->error('Error logging API request: @message', ['@message' => $e->getMessage()]);
    }
  ...
  protected function ensureApiRequestsTable() {
    ...
    if (!$schema->tableExists('dcloud_usage_api_requests')) {
      $table_spec = [
      ...
      $schema->createTable('dcloud_usage_api_requests', $table_spec);
    }
  }
