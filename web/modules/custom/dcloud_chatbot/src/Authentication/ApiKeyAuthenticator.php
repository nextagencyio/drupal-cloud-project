...
namespace Drupal\dcloud_chatbot\Authentication;
...
class ApiKeyAuthenticator implements AuthenticationProviderInterface {
  ...
  public function authenticate(Request $request) {
    ...
    if (empty($configured_key)) {
      $this->loggerFactory->get('dcloud_chatbot')->warning('API key authentication attempted but no key configured');
      return NULL;
    }
    ...
    $this->loggerFactory->get('dcloud_chatbot')->warning('Invalid API key attempted: @key', [
